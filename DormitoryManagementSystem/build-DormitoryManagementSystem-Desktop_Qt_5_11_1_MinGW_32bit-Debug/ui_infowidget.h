...
public:
    ...
    void setupUi(QDialog *newInfoDialog)
    {
        ...
        stuNameEdit = new QLineEdit(newInfoDialog);
        ...
        stuNumberEdit = new QLineEdit(newInfoDialog);
        ...
        stuSexCheck = new QComboBox(newInfoDialog);
        ...
        stuMajorEdit = new QLineEdit(newInfoDialog);
        ...
        finalCheck = new QDialogButtonBox(newInfoDialog);
        ...
        QObject::connect(finalCheck, SIGNAL(accepted()), newInfoDialog, SLOT(accept()));
        QObject::connect(finalCheck, SIGNAL(rejected()), newInfoDialog, SLOT(reject()));
    ...
    void retranslateUi(QDialog *newInfoDialog)
    {
        ...
        stuSexCheck->setItemText(0, QApplication::translate("newInfoDialog", "\347\224\267", nullptr));
        stuSexCheck->setItemText(1, QApplication::translate("newInfoDialog", "\345\245\263", nullptr));
